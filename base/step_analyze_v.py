...
class Analyze_v:
    ...
    def run(self, result_dict,  current_step):
        ...
        windbg.append_clue(f'BUGCHECK_Code:{BUGCHECK_Code}', current_step=1)
        windbg.append_clue(f'BUGCHECK_P1-BUGCHECK_P4', current_step=1)
        windbg.append_clue(f'FAILURE_BUCKET_ID', current_step=1)
        return
